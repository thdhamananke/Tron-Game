...
public class ExperimentAnalyzerforTeams {
    ...
    private static JComboBox<String> stratCombo;
    private static JComboBox<String> heurCombo;
    ...
    public static void generateAllCharts(String filePath) {
        ...
        JFreeChart pieChart = ChartTeamsGenerator.createWinPieChart(filePath);
        tabbedPane.addTab("Win Pie Chart", new ChartPanel(pieChart));

        JFreeChart timeChart = ChartTeamsGenerator.createTimeChart(filePath);
        tabbedPane.addTab("Average Time Chart", new ChartPanel(timeChart));

        JFreeChart turnsChart = ChartTeamsGenerator.createTurnsChart(filePath);
    ...
    private static JPanel createConfigPanel() {
        ...
        Runnable updateTeamsConfig = () -> {
            ...
            for (int i = 0; i < numTeams; i++) {
                ...
                tGbc.gridx = 1;
                stratCombo = new JComboBox<>(new String[]{"MinMax","AlphaBeta","MaxN","Paranoid","SOS"});
                ...
                tGbc.gridx = 1;
                heurCombo = new JComboBox<>(new String[]{"FreeSpace","Voronoi","TreeOfChambers"});
    ...
    private static void runExperiment() {
        try {
            ...
            for (int i = 0; i < nbEquipes; i++) {
                 stratCombo = stratCombos.get(i);
                heurCombo = heurCombos.get(i);
                ...
                stratCombo.setSelectedItem(stratChoice);
                heurCombo.setSelectedItem(heurChoice);
