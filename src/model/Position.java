...
/**
 * Représente une position sur la grille du jeu de Tron.
 * Une position est définie par une ligne (row) et une colonne (col).
 * 
...
public class Position {
    ...
    /**
     * Calcule la distance de Manhattan entre cette position
     * et une autre position.
     *
     ...
     * Deux positions sont égales si elles ont la même ligne
     * et la même colonne.
     *
