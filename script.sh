...
strategies=("MinMaxStrategie" "AlphaBetaStrategie" "MaxNStrategie" "ParanoidStrategie" "SOSStrategie")
heuristics=("FreeSpaceHeuristic" "VoronoiHeuristic" "TreeOfChambers")
